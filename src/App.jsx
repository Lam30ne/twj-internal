...
const docs = [
  ...
  {
    title: 'Growth Plan — The Path to $3M by 2028',
    route: '/growth-plan',
    file: 'Wonderly_Growth_Plan_to_3M_2028.html',
    tag: 'Growth',
    tagColor: '#5cc99a',
    tagBg: '#08231a',
    emoji: '📈',
    desc: 'A three-year organic plan to nearly triple revenue from $1.12M to $3M by 2028 — the four growth levers, the two-track engine, margin discipline, cash sequencing, hiring triggers, milestones, and profit distribution.',
